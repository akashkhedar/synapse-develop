# Synapse Python Library

[![fern shield](https://img.shields.io/badge/%F0%9F%8C%BF-SDK%20generated%20by%20Fern-brightgreen)](https://github.com/fern-api/fern)
[![pypi](https://img.shields.io/pypi/v/synapse-sdk.svg)](https://pypi.python.org/pypi/synapse-sdk)

The Synapse Python Library provides convenient access to the Synapse API from applications written in Python.
...
Explore the Synapse API documentation [here](https://api.synapse.io/).

# Installation

```sh
pip install --upgrade synapse-sdk
# or
...
If you use the Synapse SDK 1 package in any automated pipelines, we strongly recommend pinning your SDK version to `<2.0.0` until you can reconcile the breaking changes.

## SDK <1

The version of `synapse-sdk<1` is deprecated and no longer supported. We recommend updating to the latest version.

<details>

<summary> To use SDK <1 </summary>

If you still want to use the deprecated version, you can install it with `pip install "synapse-sdk<1"`.
...
from synapse_sdk._legacy import Project
```
...
client = Synapse(
    base_url="http://localhost:8080",   # <-- put your Synapse URL here
...
task = client.tasks.create(
    project=project.id,
    data={"text": "Synapse is the best!"}  # 'text' matches value="$text"
)
...
client.projects.import_tasks(
    ...
    request=[
        {"text": "I love Synapse"},
        {"text": "Synapse helps me ship faster"},
    ]
)
```

For additional examples, see [our API reference](https://api.synapse.io/).

<!-- Begin Contributing, generated by Fern  -->

# Contributing

Please follow [this guide to contribute to the SDK](https://github.com/Synapse/synapse-client-generator?tab=readme-ov-file#how-to-contribute)
