...
HEADERS = {}
SYNAPSE_DEFAULT_URL = "http://localhost:8080"
...
class Client(object):
    def __init__(
        ...
        """Initialize the client. Do this before using other Synapse SDK classes and methods in your script.

        Parameters
        ----------
        url: str
            Synapse host address.
            Example: http://localhost:8080
        api_key: str
            User token for the API. You can find this on your user account page in Synapse.
        ...
        versions: dict
            Versions of Synapse components for the connected instance
        make_request_raise: bool
            If true, make_request will raise exceptions on request errors
        """
        if not url:
            url = os.getenv("SYNAPSE_URL", SYNAPSE_DEFAULT_URL)
        self.url = url.rstrip("/")
        ...
        if api_key is None and credentials is None:
            raise RuntimeError(
                "If neither 'api_key' nor 'credentials' are provided, 'SYNAPSE_API_KEY' environment variable must "
                "be set"
            )
        ...
        self.is_enterprise = "synapse-enterprise-backend" in self.versions

    def get_versions(self):
        """Call /version api and get all Synapse component versions

        Returns
        -------
        dict with Synapse component names and their versions
    ...
    def check_connection(self):
        """Call Synapse /health endpoint to check the connection to the server.
    ...
    def get_projects(self, **query_params):
        """List all projects in Synapse.

        Returns
        -------
        list or `synapse_sdk.project.Project` instances

        """
        return self.list_projects(**query_params)

    def delete_project(self, project_id: int):
        """Delete a project in Synapse.
    ...
    def delete_all_projects(self):
        """Deletes all projects in Synapse.
    ...
    def get_project(self, id):
        """Return project SDK object by ID existed in Synapse
    ...
    def get_workspaces(self):
        ...
        Returns
        -------
        list of `synapse_sdk.workspaces.Workspace`
        ...
        assert (
            self.is_enterprise
        ), "Workspaces are available only for Enterprise instance of Synapse"
    ...
    def get_workspace_by_title(self, title):
        ...
        Returns
        -------
        `synapse_sdk.workspaces.Workspace` or None
    ...
    def get_url(self, suffix):
        """Get the URL of the Synapse server
    ...
    def make_request(self, method, url, *args, **kwargs):
        """Make a request with an API key to Synapse instance
