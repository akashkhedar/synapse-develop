...
from synapse_sdk._extensions.synapse_tools.core.label_config import parse_config
from synapse_sdk._extensions.synapse_tools.core.utils.io import get_local_path
...
class SynapseAttributeError(SynapseException):
    pass
...
class Project(Client):
    ...
    def get_members(self):
        ...
        Returns
        -------
        list of `synapse_sdk.users.User`

        """
        from .users import User

        assert self.is_enterprise, (
            "Project members are available in the Enterprise edition of Synapse only. "
    ...
    def get_params(self):
        ...
        show_skip_button: bool
            Whether to show a skip button in the Synapse UI and let annotators skip the task
        ...
        organization: int
            Organization ID
        color: str
            Color to decorate the project card in the Synapse UI
    ...
    def update_params(self):
        """Get [all available project parameters](#synapse_sdk.project.Project.get_params) and cache them."""
        self.params = self.get_params()

    def start_project(self, **kwargs):
        """Create a new labeling project in Synapse.
        ...
        Raises SynapseException in case of errors.
        ...
        if response.status_code == 201:
            ...
            raise SynapseException("Project not created")
    ...
    def import_tasks(self, tasks, preannotated_from_fields: List = None):
        ...
        tasks: list of dicts | dict | path to file
            Tasks in <a href="https://synapse.io/guide/tasks.html#Basic-Synapse-JSON-format">
            Synapse JSON format</a>

        preannotated_from_fields: list of strings
            Turns flat task JSON formatted like: `{"column1": value, "column2": value}` into Synapse prediction
        ...
        if isinstance(tasks, (list, dict)):
            ...
            if not os.path.isfile(tasks):
                raise SynapseException(f"Not found import tasks file {tasks}")
        ...
        if "import" in response:
            ...
            while True:
                ...
                if import_status["status"] == "failed":
                    raise SynapseException(import_status["error"])

                if time.time() - start_time >= timeout:
                    raise SynapseException("Import timeout")
    ...
    def export_tasks(
        ...
        export_type: string
            ...
            Specify another format type as referenced in <a href="https://github.com/synapse/synapse-converter/blob/master/synapse_converter/converter.py#L32">
            the Synapse converter code</a>.
    ...
    def set_model_version(self, model_version: str):
        ...
        and annotation evaluations in Synapse Enterprise, and other operations.
    ...
    def get_tasks(
        ...
        Parameters
        ----------
        filters: synapse_sdk.data_manager.Filters.create()
            JSON objects representing Data Manager filters. Use `synapse_sdk.data_manager.Filters.create()`
            helper to create it.
            Example:
        ```json
        {
        ...
        ```
        ordering: list of synapse_sdk.data_manager.Column
            List with <b>one</b> string representing Data Manager ordering.
            Use `synapse_sdk.data_manager.Column` helper class.
            Example:
    ...
    def get_paginated_tasks(
        ...
        if response.status_code == 404:
            ...
            try:
                ...
                raise SynapseException(f"Error loading tasks: {e}")
    ...
    def get_tasks_ids(self, *args, **kwargs):
        """Same as `synapse_sdk.project.Project.get_tasks()` but returns only task IDs."""
        kwargs["only_ids"] = True
        return self.get_tasks(*args, **kwargs)

    def get_paginated_tasks_ids(self, *args, **kwargs):
        """Same as `synapse_sdk.project.Project.get_paginated_tasks()` but returns
        only task IDs.
        """
        kwargs["only_ids"] = True
    ...
    def create_view(self, filters, ordering=None, title="Tasks"):
        ...
        ----------
        filters: dict
            Specify the filters(`synapse_sdk.data_manager.Filters`) of the view
        ordering: list of synapse_sdk.data_manager.Column
            List with <b>one</b> string representing Data Manager ordering.
            Use `synapse_sdk.data_manager.Column` helper class.
            Example:
    ...
    def get_unlabeled_tasks(self, only_ids=False):
        """Retrieve all tasks that are <b>not</b> completed.
         If using Synapse Enterprise, this can include tasks that have been labeled one or more times, but not the full number of times defined in the
    ...
    def get_unlabeled_tasks_ids(self):
        ...
        Synapse Enterprise, this can include tasks that have been labeled one or more times, but not the full
    ...
    def get_task(self, task_id):
        ...
        -------
        dict:
            dict of task data containing all initial data and annotation results in [Synapse JSON format](https://synapse.io/guide/tasks.html#Basic-Synapse-JSON-format)
    ...
    def update_task(self, task_id, **kwargs):
        ...
        kwargs: kwargs parameters
            List of parameters to update. Check all available parameters [here](https://synapse.io/api#operation/api_tasks_partial_update)
    ...
    def create_prediction(
        ...
        result: list or dict or str
            Result in the <a href="https://synapse.io/guide/export.html#Synapse-JSON-format-of-annotated-tasks">
            Synapse JSON format as for annotations</a>.
    ...
    def create_predictions(self, predictions):
        """Bulk create predictions for tasks. See <a href="https://synapse.io/guide/predictions.html">more
        details about pre-annotated tasks</a>.

        Parameters
        ----------
        predictions: list of dicts
            List of dicts with predictions in the <a href="https://synapse.io/guide/export.html#Synapse-JSON-format-of-annotated-tasks">
            Synapse JSON format as for annotations</a>.
        """
        response = self.make_request(
    ...
    def create_annotation(self, task_id: int, **kwargs) -> Dict:
        ...
        task_id: int
            Task ID you want to update
        kwargs: kwargs parameters
            List of parameters to create. Check all available parameters [here](https://synapse.io/api#operation/api_tasks_annotations_create).
    ...
    def update_annotation(self, annotation_id, **kwargs):
        ...
        kwargs: kwargs parameters
            List of annotation parameters. Check all available parameters [here](https://synapse.io/guide/export.html#Synapse-JSON-format-of-annotated-tasks)
    ...
    def connect_google_import_storage(
        ...
        """Connect a Google Cloud Storage (GCS) bucket to Synapse to use as source storage and import tasks.
        ...
        title: string
            Optional, specify a title for your GCS import storage that appears in Synapse.
        description: string
    ...
    def connect_google_export_storage(
        ...
        """Connect a Google Cloud Storage (GCS) bucket to Synapse to use as target storage and export tasks.
        ...
        google_application_credentials: string
            Optional, provide a file with your Google application credentials. If not specified, it will use path stored in `GOOGLE_APPLICATION_CREDENTIALS` environmental variable. Read more about [Google Cloud authentication](https://cloud.google.com/docs/authentication/getting-started)
        title: string
            Optional, specify a title for your GCS export storage that appears in Synapse.
        description: string
            Optional, specify a description for your GCS export storage.
        can_delete_objects: bool
            False by default. Specify whether to delete tasks in the GCS bucket if they are deleted in Synapse.
    ...
    def connect_s3_import_storage(
        ...
        """Connect an Amazon S3 bucket to Synapse to use as source storage and import tasks.
        ...
        presign_ttl: int
            Optional, 1 by default. Specify how long to keep presigned URLs active.
        title: string
            Optional, specify a title for your S3 import storage that appears in Synapse.
        description: string
    ...
    def connect_s3s_iam_import_storage(
        ...
        external_id: string or None
            ...
            and use external_id from the response. You can find this ID on the organization page in the Synapse UI.
        bucket: string
            Specify the name of the S3 bucket.
        prefix: string
            Optional, specify the prefix within the S3 bucket to import your data from.
    ...
    def connect_s3_export_storage(
        ...
        """Connect an Amazon S3 bucket to Synapse to use as target storage and export tasks.
        ...
        title: string
            Optional, specify a title for your S3 export storage that appears in Synapse.
        description: string
        ...
        s3_endpoint: string
            Optional, specify an S3 endpoint URL to use to access your bucket instead of the standard access method.
        can_delete_objects: bool
            False by default. Specify whether to delete tasks in the S3 bucket if they are deleted in Synapse.
    ...
    def connect_azure_import_storage(
        ...
        """Connect a Microsoft Azure BLOB storage container to Synapse to use as source storage and import tasks.
        ...
        presign_ttl: int
            Optional, 1 by default. Specify how long to keep presigned URLs active.
        title: string
            Optional, specify a title for your Azure import storage that appears in Synapse.
        description: string
    ...
    def connect_azure_export_storage(
        ...
        """Connect Microsoft Azure BLOB storage to Synapse to use as target storage and export tasks.
        ...
        title: string
            Optional, specify a title for your Azure export storage that appears in Synapse.
        description: string
            Optional, specify a description for your Azure export storage.
        can_delete_objects: bool
            False by default. Specify whether to delete tasks in the Azure container if they are deleted in Synapse.
        account_name: string
            Optional, specify the name of the account with access to the container.
        account_key: string
            Optional, specify the key for the account with access to the container.
    ...
    def connect_local_import_storage(
        ...
        """Connect a Local storage to Synapse to use as source storage and import tasks.
        Parameters
        ----------
        ...
        last_sync_count: int
            Number of tasks synced in the last sync
        """
        if "SYNAPSE_LOCAL_FILES_DOCUMENT_ROOT" not in os.environ:
            raise ValueError(
                "To use connect_local_import_storage() you should set "
                "SYNAPSE_LOCAL_FILES_DOCUMENT_ROOT environment variable, "
                "read more: https://synapse.io/guide/storage.html#Prerequisites-2"
            )
        root = os.environ["SYNAPSE_LOCAL_FILES_DOCUMENT_ROOT"]
    ...
    def sync_export_storage(self, storage_type, storage_id):
        ...
        created_at: str
            Creation time
        other fields:
            See more https://api.synapse.io/#tag/Storage:S3/operation/api_storages_export_s3_sync_create
        """
        response = self.make_request(
    ...
    def export_snapshot_create(
        ...
        task_filter_options: dict
            ...
            <a href="https://api.synapse.io/#operation/api_projects_exports_create">check the API parameters for more details</a>
    ...
    def export(
        ...
        **kwargs,
        ...
        filters : data_manager.Filters, dict, optional
            ...
            The format of the filters should match the Synapse filter options.
            Default is None, which means all tasks are exported.
            Use synapse_sdk.data_manager.Filters.create() to create filters,
        ...
        export_type : str, optional
            The format of the exported data. It should be one of the formats supported by Synapse ('JSON', 'CSV', etc.). Default is 'JSON'.
    ...
    def export_snapshot_status(self, export_id: int) -> ExportSnapshotStatus:
        ...
        Returns
        -------
        `synapse_sdk.project.ExportSnapshotStatus`
    ...
    def export_snapshot_download(
        ...
        if response.status_code == 200:
            ...
            if content_disposition:
                ...
                raise SynapseException("No filename in response")
