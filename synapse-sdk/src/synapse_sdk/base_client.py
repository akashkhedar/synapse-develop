...
class SynapseBase:
    ...
    environment : SynapseEnvironment
        The environment to use for requests from the client. from .environment import SynapseEnvironment



        Defaults to SynapseEnvironment.DEFAULT
    ...
    def __init__(
        ...
        *,
        ...
        environment: SynapseEnvironment = SynapseEnvironment.DEFAULT,
        api_key: typing.Optional[str] = os.getenv("SYNAPSE_API_KEY"),
        ...
        if api_key is None:
            raise ApiError(
                body="The client must be instantiated be either passing in api_key or setting SYNAPSE_API_KEY"
            )
...
def _get_base_url(*, base_url: typing.Optional[str] = None, environment: SynapseEnvironment) -> str:
