...
from synapse_sdk.converter import brush
from synapse_sdk.converter.audio import convert_to_asr_json_manifest
from synapse_sdk.converter.keypoints import (
...
from synapse_sdk.converter.exports import csv2
from synapse_sdk.converter.utils import (
    parse_config,
...
from synapse_sdk.converter.exports.yolo import process_and_save_yolo_annotations
...
class Converter(object):
    _FORMAT_INFO = {
        Format.JSON: {
            ...
            "and the annotations for a dataset. It's Synapse Common Format",
            "link": "https://synapse.io/guide/export.html#JSON",
        },
        Format.JSON_MIN: {
            "title": "JSON-MIN",
            ...
            "link": "https://synapse.io/guide/export.html#JSON-MIN",
        },
        Format.CSV: {
            "title": "CSV",
        ...
        Format.COCO: {
            ...
            "link": "https://synapse.io/guide/export.html#COCO",
        ...
        Format.VOC: {
            ...
            "link": "https://synapse.io/guide/export.html#Pascal-VOC-XML",
        ...
        Format.YOLO: {
            ...
            "link": "https://synapse.io/guide/export.html#YOLO",
            "tags": ["image segmentation", "object detection", "keypoints"],
        },
        ...
        Format.BRUSH_TO_NUMPY: {
            ...
            "link": "https://synapse.io/guide/export.html#Brush-labels-to-NumPy-amp-PNG",
        ...
        Format.ASR_MANIFEST: {
            ...
            "link": "https://synapse.io/guide/export.html#ASR-MANIFEST",
    ...
    def __init__(
        ...
        """Initialize Synapse Converter for Exports

        :param config: string or dict: XML string with Synapse labeling config or path to this file or parsed_config
    ...
    def convert(self, input_data, output_data, format, is_dir=True, **kwargs):
        ...
        if format == Format.JSON:
            ...
            from synapse_sdk.converter.exports.brush_to_coco import convert_to_coco
    ...
    def convert_to_coco(
        ...
        for item_idx, item in enumerate(item_iterator):
            ...
            for label in labels:
                ...
                if os.getenv("SYNAPSE_FORCE_ANNOTATOR_EXPORT"):
    ...
    def rotated_rectangle(label):
        ...
        if abs(label_r) > 0:
            ...
            beta = math.pi * (
                label_r / 180
            )  # Synapse defines the angle towards the vertical axis

            radius = math.sqrt((label_w / 2) ** 2 + (label_h / 2) ** 2)

            # Synapse saves the position of top left corner after rotation
            x_0 = (
                label_x
                - radius
    ...
    def convert_to_voc(
        ...
        for item_idx, item in enumerate(item_iterator):
            ...
            create_child_node(doc, "name", "Synapse", owner_node)
