...
from synapse_sdk.converter.utils import ensure_dir, get_annotator
import synapse_sdk.converter.brush as brush_module
...
def convert_to_coco(items, output_dir, output_image_dir=None):
    """Convert Synapse annotations to COCO format
    ...
    coco_data = {
        ...
        'info': {
            ...
            'version': '1.0',
            'description': 'Converted from Synapse',
            'contributor': 'Synapse Converter',
