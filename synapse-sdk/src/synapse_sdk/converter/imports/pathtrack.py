"""PathTrack BBoxes to Synapse convert
...
def convert_shot(
    ...
    """Convert bounding boxes from PathTrack to Synapse video format
...
def convert_dataset(
    ...
    """Convert PathTrack dataset to Synapse video labeling format
    ...
    logger.info("Saving Synapse JSON: %s", path)
