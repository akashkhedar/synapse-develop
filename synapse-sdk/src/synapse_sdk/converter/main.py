...
from synapse_sdk.converter.converter import (
    Converter,
    Format,
    FormatNotSupportedError,
)
from synapse_sdk.converter.exports.csv import ExportToCSV
from synapse_sdk.converter.imports import yolo as import_yolo, coco as import_coco
...
def get_export_args(parser):
    ...
    parser.add_argument(
        ...
        dest="project_dir",
        default=None,
        help="Synapse project directory path",
    )
    parser.add_argument(
        "--heartex-format",
        dest="heartex_format",
...
def get_all_args():
    ...
    parser_export = subparsers.add_parser(
        "export",
        help="Converter from Synapse JSON annotations to external formats",
    )
    ...
    parser_import = subparsers.add_parser(
        "import",
        help="Converter from external formats to Synapse JSON annotations",
    )
