""" # Data Manager module for the Synapse SDK

    Classes can be used to filter, order, and select items in `synapse_sdk.project.Project.get_tasks`
    ...
    ```python
    from synapse_sdk.data_manager import Filters, Column, Operator, Type
...
class Filters:
    """
    Use the methods and variables in this class to create and combine filters for tasks on the Synapse Data Manager.
    """
    ...
    def create(conjunction, items):
        """Create a filter for `synapse_sdk.project.Project.get_tasks()`
...
class Column:
    """Specify the column on the Data Manager in Synapse UI to use in the filter."""
