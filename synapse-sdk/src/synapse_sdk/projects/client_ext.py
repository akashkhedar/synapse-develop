...
from synapse_sdk._extensions.pager_ext import SyncPagerExt, AsyncPagerExt, T
from synapse_sdk.types.lse_project_response import LseProjectResponse
...
class ProjectExt(LseProjectResponse):
    ...
    def get_synapse_interface(self):
