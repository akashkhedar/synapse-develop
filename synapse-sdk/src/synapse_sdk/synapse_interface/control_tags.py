...
from .base import SynapseTag, get_tag_class
...
class ControlTag(SynapseTag):
    """
    Class that represents a ControlTag in Synapse
    ...
    def validate_value(self, value: dict) -> bool:
        """
        Given "value" from [annotation result format](https://synapse.io/guide/task_format),
