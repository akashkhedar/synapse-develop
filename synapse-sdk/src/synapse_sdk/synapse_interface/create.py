...
from synapse_sdk.synapse_interface.base import SynapseTag

import synapse_sdk.synapse_interface.object_tags as OT
import synapse_sdk.synapse_interface.control_tags as CT
...
def _convert(name: str, tag: Union[str, list, tuple, SynapseTag]) -> tuple:
    """
    ...
    Raises:
        TypeError: If input tag is not a str, list, tuple, or SynapseTag.
    """
    
    if isinstance(tag, SynapseTag):
        ...
        raise TypeError("Input tag must be one of str, list, tuple, SynapseTag")
