    ...
    def update(
        ...
        *,
        ...
        data : typing.Optional[typing.Optional[typing.Any]]
            User imported or uploaded data for a task. Data is formatted according to the project label config. You can find examples of data for your project on the Import page in the Synapse Data Manager UI.
