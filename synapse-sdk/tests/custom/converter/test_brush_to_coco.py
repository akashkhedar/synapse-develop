...
from synapse_sdk.converter.exports.brush_to_coco import (
...
@patch('synapse_sdk.converter.exports.brush_to_coco.brush_module.decode_rle')
...
@patch('synapse_sdk.converter.exports.brush_to_coco.generate_contour_from_rle')
@patch('synapse_sdk.converter.exports.brush_to_coco.generate_contour_from_polygon')
def test_convert_to_coco(mock_gen_polygon, mock_gen_rle, sample_annotation_items, tmp_path):
    """Test conversion of Synapse annotations to COCO format"""
...
def test_convert_to_coco_with_custom_output_dir(sample_annotation_items, tmp_path):
    ...
    # Mock the contour generation functions
    with patch('synapse_sdk.converter.exports.brush_to_coco.generate_contour_from_rle') as mock_gen_rle, \
         patch('synapse_sdk.converter.exports.brush_to_coco.generate_contour_from_polygon') as mock_gen_polygon:
