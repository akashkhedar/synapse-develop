...
from synapse_sdk.converter.exports.yolo import process_keypoints_for_yolo
...
def test_convert_to_yolo(create_temp_folder):
    """Check converstion synapse json exported file to yolo with multiple labelers"""
...
def test_convert_to_yolo_obb(create_temp_folder):
    """Check conversion synapse json exported file to a yolo obb compatible format"""
...
def test_convert_polygons_to_yolo(create_temp_folder):
    """Check conversion synapse json exported file to yolo with polygons"""
...
def test_convert_annotation_to_yolo_format():
    """
    Verify conversion from Synapse annotation to normalized Yolo format.

    This test case evaluates the conversion of LS (Synapse) annotations to normalized
    Yolo format. It iterates over a list of Synapse annotations and compares the result of the
    conversion to expected values.

    Test Procedure:
    1. Define Synapse annotations and their corresponding expected Yolo representations.
...
def test_convert_annotation_to_yolo_obb_format():
    """
    Verify conversion from Synapse annotation to normalized Yolo OBB format.

    This test case evaluates the conversion of LS (Synapse) annotations to normalized
    Yolo Oriented Bounding Box (OBB) format. It iterates over a list of Synapse annotations and
    compares the result of the conversion to expected values.

    Test Procedure:
    1. Define Synapse annotations and their corresponding expected Yolo OBB representations.
    2. Iterate over each LS annotation and perform the conversion.
