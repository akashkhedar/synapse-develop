...
from synapse_sdk._extensions.synapse_tools.core.utils.io import (
    get_local_path,
    _DIR_APP_NAME,
)
...
@patch(
    "synapse_sdk._extensions.synapse_tools.core.utils.io.get_data_dir",
    return_value="test-data-dir/",
)
@patch(
    "synapse_sdk._extensions.synapse_tools.core.utils.io.get_cache_dir",
...
@patch("synapse_sdk._extensions.synapse_tools.core.utils.io.get_data_dir", return_value="test-data-dir/")
@patch("synapse_sdk._extensions.synapse_tools.core.utils.io.get_cache_dir", return_value="test-data-dir/.cache/synapse")
@patch("synapse_sdk._extensions.synapse_tools.core.utils.io.LOCAL_FILES_DOCUMENT_ROOT", "/my_files")
