...
def parse_input_args(input_args):
    ...
    root_parser.add_argument('--version', dest='version', action='store_true', help='Show Synapse version')
    root_parser.add_argument(
        '-b',
        '--no-browser',
        dest='no_browser',
        action='store_true',
        help='Do not open browser when starting Synapse',
    )
    root_parser.add_argument(
    ...
    root_parser.add_argument(
        ...
        type=str,
        default='',
        help='Synapse full hostname for generating imported task urls, sample task urls, static loading, etc.\n'
    ...
    parser = argparse.ArgumentParser(description='Synapse', parents=[root_parser])
    ...
    parser_init = subparsers.add_parser('init', help='Initialize Synapse', parents=[root_parser])
    ...
    parser_start = subparsers.add_parser('start', help='Start Synapse server', parents=[root_parser])
