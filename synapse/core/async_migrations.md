...
Model for tracking async migration status (`synapse/core/models.py:12`).
...
The main tool for creating new async migrations is located in `synapse/core/migration_helpers.py:55`.
