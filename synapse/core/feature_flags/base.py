...
from synapse.core.current_request import get_current_request
from synapse.core.utils.common import load_func
from synapse.core.utils.io import find_node
from synapse.core.utils.params import get_all_env_with_prefix, get_bool_env
...
def get_feature_file_path():
    package_name = 'synapse' if settings.VERSION_EDITION == 'Community' else 'synapse_enterprise'
