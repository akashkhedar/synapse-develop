...
from synapse_sdk._extensions.synapse_tools.core import label_config
from rest_framework.exceptions import ValidationError

from synapse.core.utils.io import find_file
...
def parse_config(config_string):
    ...
    """
    logger.warning('Using deprecated method - switch to synapse.tools.label_config.parse_config!')
