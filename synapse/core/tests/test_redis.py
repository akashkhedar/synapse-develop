...
from synapse.core.redis import is_job_on_worker
...
def test_is_job_on_worker_does_not_call_get_job_ids():
    ...
    with patch('synapse.core.redis.StartedJobRegistry') as registry_cls:
...
def test_is_job_on_worker_safe_from_non_main_thread(monkeypatch):
    ...
    with patch('synapse.core.redis.StartedJobRegistry', DummyRegistry):
