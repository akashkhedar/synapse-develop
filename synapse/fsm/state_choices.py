...
"""
Core state choice enums for Synapse entities.
These enums define the essential states for core Synapse entities.
"""
...
class TaskStateChoices(models.TextChoices):
    """
    Core task states for basic Synapse workflow.
...
class AnnotationStateChoices(models.TextChoices):
    """
    Core annotation states for basic Synapse workflow.
...
class ProjectStateChoices(models.TextChoices):
    """
    Core project states for basic Synapse workflow.
