...
# =============================================================================
# Core State Models for Synapse OSS
# =============================================================================
...
class TaskState(BaseState):
    """
    Core task state tracking for Synapse.
...
class AnnotationState(BaseState):
    """
    Core annotation state tracking for Synapse.
...
class ProjectState(BaseState):
    """
    Core project state tracking for Synapse.
