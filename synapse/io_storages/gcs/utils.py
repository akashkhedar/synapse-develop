...
class GCS(object):
    ...
    def get_client(
        ...
        if cache_key not in GCS._client_cache:
            ...
            # use credentials from Synapse Cloud Storage settings
    ...
    def _get_default_credentials(cls):
        """Get default GCS credentials for Synapse Cloud Storages"""
        ...
        try:
            ...
            logger.warning(f'Synapse could not load default GCS credentials from env. {exc}', exc_info=True)
            GCS._credentials_cache = {}
