...
class LocalFilesMixin(models.Model):
    ...
    def community_auto_hint():
        if settings.VERSION_EDITION == 'Community':
            return (
                ' Community tip: create a "mydata" or "synapse-data" directory next to the Synapse '
    ...
    def validate_connection(self):
        ...
        if settings.LOCAL_FILES_SERVING_ENABLED is False:
            raise ValidationError(
                ...
                'variable to "true" and restart Synapse. See '
                'https://synapse.io/guide/storage.html#Local-storage for details.'
                '\n\n'
