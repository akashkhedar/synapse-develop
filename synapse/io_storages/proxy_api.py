...
from synapse.io_storages.utils import parse_range
...
class ResolveStorageUriAPIMixin:
    def resolve(self, request: HttpRequest, fileuri: str, instance: Union[Task, Project]) -> Response:
        ...
        # and all files are proxied through Synapse using Synapse auth and RBAC control.
...
class TaskResolveStorageUri(ResolveStorageUriAPIMixin, APIView):
    ...
    If the storage has presign=False, it will proxy the data through Synapse
    ...
    def get(self, request, *args, **kwargs):
        """Get the presigned url for a given fileuri or proxy data through Synapse"""
