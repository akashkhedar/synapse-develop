...
Currently supporting a feature in [Synapse Enterprise](https://github.com/Synapse/synapse-enterprise).

## ModelInterface

Defines a "type signature" for the inputs and outputs for an LLM call as related to a Synapse project.
...
python -m django_diagram --settings=core.settings.synapse --app=ml_models --output=ml_models/README.md
```
