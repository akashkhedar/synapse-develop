...
This doc summarizes how Synapse Enterprise selects the next task for labeling, based on the current code in `synapse/projects/functions/next_task.py` and LSE-specific logic from `synapse_enterprise/lse_projects/functions.py`.
...
## References
- Core selection: `synapse/projects/functions/next_task.py`
- LSE agreement & counters: `synapse_enterprise/lse_projects/functions.py`
