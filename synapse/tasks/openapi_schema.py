...
annotation_request_schema = {
    ...
    'properties': {
        'result': {
            'type': 'array',
            'items': {'type': 'object'},
            'description': 'Labeling result in JSON format. Read more about the format in [the Synapse documentation.](https://synapse.io/guide/task_format)',
...
prediction_request_schema = {
    ...
    'properties': {
        ...
        'result': {
            'type': 'array',
            'items': {'type': 'object'},
            'description': 'Prediction result in JSON format. Read more about the format in [the Synapse documentation.](https://synapse.io/guide/predictions)',
            'example': result_example,
        },
        'score': {
            'type': 'number',
