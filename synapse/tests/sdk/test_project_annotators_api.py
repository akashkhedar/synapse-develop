...
def test_project_annotators_sdk(django_live_url, business_client):
    ...
    proj = client.projects.create(title='Annotators Project', label_config=LABEL_CONFIG_AND_TASKS['label_config'])
    ...
    u2 = client.users.create(email='a2@example.com', username='annotator2', first_name='A', last_name='Two')
    u3 = client.users.create(email='a3@example.com', username='annotator3', first_name='A', last_name='Three')
    ...
    resp = list(client.projects.list_unique_annotators(id=proj.id))
