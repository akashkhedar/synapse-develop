...
@method_decorator(
    ...
    decorator=extend_schema(
        ...
        description="""
    Save details for a specific user, such as their name or contact information, in Synapse.
    """,
        parameters=[
...
@method_decorator(
    ...
    decorator=extend_schema(
        tags=['Users'],
        summary='List users',
        description='List the users that exist on the Synapse server.',
        extensions={
...
@method_decorator(
    ...
    decorator=extend_schema(
        ...
        description='Create a user in Synapse.',
        request={
...
@method_decorator(
    ...
    decorator=extend_schema(
        ...
        description='Get info about a specific Synapse user, based on the user ID.',
        parameters=[
            OpenApiParameter(name='id', type=OpenApiTypes.INT, location='path', description='User ID'),
        ],
        request=None,
...
@method_decorator(
    ...
    decorator=extend_schema(
        tags=['Users'],
        summary='Delete user',
        description='Delete a specific Synapse user.',
        parameters=[
            OpenApiParameter(name='id', type=OpenApiTypes.INT, location='path', description='User ID'),
        ],
        request=None,
