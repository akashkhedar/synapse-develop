...
import { IconCollapseSmall, IconExpandSmall } from "@synapse/icons";
import { cnm } from "@synapse/ui/utils/utils";
    ...
    >
      ...
      >
        ...
        <button
          ...
          className="sf-button sf-button_look_ sf-collapsible-bottom-panel-toggle absolute right-[5px] top-1/2 -translate-y-1/2 !h-6 !w-6 !p-0 flex items-center justify-center !bg-transparent !border-none"
          style={{ zIndex: 10 }}
        >
