  ...
  describe("PlaygroundApp: Loads configs from v1 URL", () => {
    it.each([
      ...
      },
      {
        ...
        expectedConfig: `<View>
      <Header value=\"Note: To manage relations you need Synapse entity panel to be shown\" />·
      <Relations>
        <Relation value=\"Is A\" />
