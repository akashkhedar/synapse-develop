...
const SAMPLE_WEBSITE = "<a href='https://synapse.io'>https://synapse.io</a>";
const SAMPLE_PDF_EMBED = "<embed src='https://app.heartex.ai/static/samples/sample.pdf' width='100%' height='600px'/>";
const SAMPLE_WEBSITE_EMBED = "<iframe src='https://synapse.io' width='100%' height='600px'/>";
...
// Utility to generate a sample task from a Synapse XML config
