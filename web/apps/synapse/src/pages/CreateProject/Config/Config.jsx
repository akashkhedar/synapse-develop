...
import { Button, cnm } from "@synapse/ui";
import { IconTrash } from "@synapse/icons";
...
import tags from "@synapse/core/lib/utils/schema/tags.json";
import { UnsavedChanges } from "./UnsavedChanges";
import { Checkbox, CodeEditor, Select } from "@synapse/ui";
...
const EmptyConfigPlaceholder = () => (
  <div className={configClass.elem("empty-config")}>
    ...
    <p>
      ...
      <a href="https://synapse.io/tags/" target="_blank" rel="noreferrer">
