import { SampleDatasetSelect } from "@synapse/app-common/blocks/SampleDatasetSelect/SampleDatasetSelect";
import { ff, formatFileSize } from "@synapse/core";
import { IconCode, IconErrorAlt, IconFileUpload, IconInfoOutline, IconTrash, IconUpload } from "@synapse/icons";
import { Badge } from "@synapse/shad/components/ui/badge";
import { cn as scn } from "@synapse/shad/utils";
...
import "./Import.scss";
import { Button, CodeBlock, SimpleCard, Spinner, Tooltip, Typography } from "@synapse/ui";
                      ...
                      <dt>
                        <div className="flex items-center gap-1">
                          ...
                          <Tooltip title="Video format support depends on your browser. Click to learn more.">
                            <a
                              href="https://synapse.io/tags/video#Video-format"
                              target="_blank"
