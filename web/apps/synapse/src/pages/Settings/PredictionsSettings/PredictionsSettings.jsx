...
import { EmptyState, SimpleCard } from "@synapse/ui";
import { IconPredictions, Typography, IconExternal } from "@synapse/ui";
        ...
        {loaded && versions.length > 0 && (
          <>
            ...
            <Typography size="small" className="text-neutral-content-subtler mt-base mb-wider">
              ...
              <a href="https://synapse.io/guide/predictions.html" target="_blank" rel="noreferrer">
              ...
              footer={
                !window.APP_SETTINGS?.whitelabel_is_active && (
                  <Typography variant="label" size="small" className="text-primary-link">
                    <a
                      href="https://synapse.io/guide/predictions"
                      target="_blank"
