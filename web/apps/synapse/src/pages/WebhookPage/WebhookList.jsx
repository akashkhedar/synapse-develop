        ...
        {webhooks.length === 0 ? (
          <SimpleCard title="" className="bg-primary-background border-primary-border-subtler p-base">
            <EmptyState
              ...
              description="Setup integrations that subscribe to certain events using Webhooks. When an event is triggered, Synapse sends an HTTP POST request to the configured webhook URL."
              actions={
                canChangeWebhooks ? (
              ...
              footer={
                !window.APP_SETTINGS.whitelabel_is_active && (
                  <Typography variant="label" size="small" className="text-primary-link">
                    <a
                      href="https://docs.Synapse.com/guide/webhooks.html"
                      target="_blank"
