/**
 * State Registry System for Synapse
 *
 * This module provides an extensible state management system that allows
 * Synapse Enterprise to extend state definitions without modifying base code.
 *
...
// ============================================================================
// Core State Registrations (Synapse Open Source)
// ============================================================================
