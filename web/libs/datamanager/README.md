...
Synapse DataManager is a vital component within the Synapse ecosystem, designed to efficiently manage and navigate through annotated data. It provides users with advanced capabilities to organize, filter, and browse their datasets seamlessly.


### Features

DataManager boasts several key features, enhancing data handling within Synapse:
...
- Integration with Synapse Frontend: Ensures cohesive functionality with the Synapse Frontend.
...
- **`yarn dm:watch`: Build DataManager continuously.**
    - This script is essential for development. It continuously builds DataManager, allowing developers to see their changes in real-time within the Synapse environment.
...
DataManager integrates closely with Synapse, handling various events:
