...
DataManager uses Synapse API to operate.
...
| Property    | Type             | Description                                               |
| ----------- | ---------------- | --------------------------------------------------------- |
| annotations | List<Annotation> | See Synapse documentation to learn about annotations |
...
| Property    | Type             | Description                                                  |
| ----------- | ---------------- | ------------------------------------------------------------ |
| annotations | List<Annotation> | See Synapse documentation to learn more about annotations |
