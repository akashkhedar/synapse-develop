...
import { IconCode, IconCopyOutline, IconChevronDown } from "@synapse/icons";
import { AutoSizerTable, Tooltip, Button } from "@synapse/ui";
    ...
    const headerCheckboxCell = useCallback(() => {
      return (
        <TableCheckboxCell
          ...
          ariaLabel={`${
            selectedItems.isAllSelected ? "Unselect" : "Select"
          } all rows`}
        />
      );
