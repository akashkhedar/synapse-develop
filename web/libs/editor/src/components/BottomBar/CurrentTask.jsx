...
import { Button, IconChevronLeft, IconChevronRight, Tooltip } from "@synapse/ui";
...
export const CurrentTask = observer(({ store }) => {
  ...
  // Note: store.hasInterface("postpone") is set by sf-sdk based on task.allow_postpone from API
  const canPostpone =
