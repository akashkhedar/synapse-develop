...
import { IconOutlinerDrag, IconCollapseSmall, IconExpandSmall } from "@synapse/ui";
...
enum DragOverHeightClasses {
  tabLeft = "sf-drag_over_tab_left",
  tabRight = "sf-drag_over_tab_right",
  emptyTabSpace = "sf-drag_over_empty_tab_space",
}
