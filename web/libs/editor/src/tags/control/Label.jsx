 ...
 * @meta_description Customize Synapse with the Label tag to assign a single label to regions in a task for machine learning and data science projects.
 ...
 * @param {int} [category]                  - Category is used in the export (in Synapse-converter lib) to make an order of labels for YOLO and COCO
 */
