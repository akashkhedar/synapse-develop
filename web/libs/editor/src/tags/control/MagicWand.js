 ...
 * [Synapse storage guide](../guide/storage.html#Troubleshoot-CORS-and-access-problems) for more
 ...
 * use Synapse's signed URL support ([AWS](../guide/storage.html#Set-up-connection-in-the-Synapse-UI),
 * [GCP](../guide/storage.html#Set-up-connection-in-the-Synapse-UI-1), and
 * [Azure](../guide/storage.html#Set-up-connection-in-the-Synapse-UI-2)).
 *
 * If the image is on the same host as your Synapse instance, you can simply leave off the
 ...
 * @meta_description Customize Synapse with a Magic Wand tag to quickly click and drag to threshold flood fill image areas during image segmentation labeling for machine learning and data science projects.
