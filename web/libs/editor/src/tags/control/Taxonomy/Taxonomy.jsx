 ...
 * @meta_description Customize Synapse with the Taxonomy tag and use hierarchical labels for machine learning and data science projects.
  ...
  .actions((self) => {
    ...
    return {
      ...
      updateValue: flow(function* (store) {
        ...
        // trying to presign this url if needed and if handler is passed into SF
