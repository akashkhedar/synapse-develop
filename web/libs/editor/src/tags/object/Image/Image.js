 ...
 * @meta_description Customize Synapse with the Image tag to annotate images for computer vision machine learning and data science projects.
...
const Model = types
  ...
  .actions((self) => {
    ...
    function afterAttach() {
      ...
      // Always add crosshair toggle for annotators
      manager.addTool("CrosshairTool", Tools.Crosshair.create({}, env), "CrosshairTool");
