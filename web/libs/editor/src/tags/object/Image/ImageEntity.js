    ...
    preload() {
      ...
      if (isFF(FF_IMAGE_MEMORY_USAGE)) {
        ...
        new Promise((resolve) => {
          ...
          img.onload = () => {
            if (!isAlive(self)) return resolve();
            try {
              ...
              console.warn("[ImageEntity] onload handler failed:", e);
            }
            resolve();
          };
          img.onerror = () => {
            ...
            try {
              ...
              console.warn("[ImageEntity] onerror handler failed:", e);
            }
            resolve();
          };
          img.src = self.src;
        ...
        .then((url) => {
          if (isAlive(self)) {
            try {
              ...
              console.warn("[ImageEntity] fileLoader.then handler failed:", e);
            }
          }
        })
        .catch(() => {
