...
import { IconHelp } from "@synapse/icons";
import { Toggle, Tooltip } from "@synapse/ui";
import { cn } from "../../../utils/bem";
import { cnm } from "@synapse/shad/utils";
...
const ParagraphAudio = observer(({ item }) => {
  ...
  return (
    <>
      {isBuffering && <div className="sf-timeline-controls__buffering" aria-label="Buffering Media Source" />}
      <audio
        {...audioDefaultProps}
