import * as ff from "@synapse/core/lib/utils/feature-flags/ff";
 ...
 * @param {url|text} [valueType=url|text]                 – source of the data, check (Data retrieval)[https://synapse.io/guide/tasks.html] page for more inforamtion
