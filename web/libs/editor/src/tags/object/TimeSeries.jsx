 ...
 * </View>
 * @example
 * <!--Labeling configuration for time series data stored in the task field `ts` in Synapse JSON format. The time field is stored as a date in the `timeformat` field and formatted as a full date on the plot (by default). -->
 * <View>
 ...
 * @meta_description Customize Synapse with the TimeSeries tag to annotate time series data for machine learning and data science projects.
 ...
 * @param {url|json} [valueType=url] Format of time series data provided. If set to "url" then Synapse loads value references inside `value` key, otherwise it expects JSON.
