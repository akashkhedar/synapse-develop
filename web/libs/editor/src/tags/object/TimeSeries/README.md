...
This document explains how the **TimeSeries** component in Synapse is built, how its synchronisation with other media works (video / audio), and how the playback cursor logic is implemented.
