 ...
 * - `output_video.mp4` is the converted video file ready for use in Synapse.
 *
 * Using this FFmpeg command to re-encode your videos will help eliminate playback issues and ensure that Synapse detects the total video duration accurately, providing a smooth annotation experience.
 *
 ...
 * @meta_description Customize Synapse with the Video tag for basic video annotation tasks for machine learning and data science projects.
