...
/**
 * The `Style` tag is used in combination with the View tag to apply custom CSS properties to the labeling interface. See the [CSS Reference](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference) on the MDN page for a full list of available properties that you can reference. You can also adjust default Synapse CSS classes. Use the browser developer tools to inspect the element on the UI and locate the class name, then specify that class name in the `Style` tag.
 *
 * @example
 ...
 * </View>
 * @example
 * <!-- Adjust the default CSS styling in Synapse to surround each radio button choice with a solid green border -->
 * <View>
 * <Style>
 ...
 * @meta_description Customize Synapse with CSS styles to modify the labeling interface for machine learning and data science projects.
