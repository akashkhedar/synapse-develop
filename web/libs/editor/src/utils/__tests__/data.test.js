...
describe("parseValue", () => {
  const data = {
    html: '<a href="https://synapse.io">Synapse</a>',
    url: "https://synapse.io",
    name: "Synapse",
    num2str: "123",
    messages: {
      greeting: "Hey!",
  ...
  test("Variable", () => {
    expect(parseValue("$url", data)).toEqual("https://synapse.io");
  });
  ...
  test("Text with one variable", () => {
    expect(parseValue("URL: $url", data)).toEqual("URL: https://synapse.io");
  });

  test("Text with variables", () => {
    expect(parseValue("URL of $name is $url", data)).toEqual("URL of Synapse is https://synapse.io");
  });
