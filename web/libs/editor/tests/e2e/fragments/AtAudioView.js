...
module.exports = {
  ...
  _controlMenuSelector: ".sf-audio-control",
  _settingsMenuSelector: ".sf-audio-config",
  _volumeSliderSelector: ".sf-audio-slider__range",
  _volumeInputSelector: ".sf-audio-slider__input",
  _muteButtonSelector: ".sf-audio-control__mute-button",
  ...
  _hideTimelineButtonSelector: ".sf-audio-config__buttons > .sf-audio-config__menu-button:nth-child(1)",
  _hideWaveformButtonSelector: ".sf-audio-config__buttons > .sf-audio-config__menu-button:nth-child(2)",
