 ...
 */
module.exports = {
  _rootSelector: ".sf-details",
  _labelSelector: ".sf-detailed-region .sf-labels-list span",
  _textSelector: ".sf-region-meta__content_type_text",
  _editMetaSelector: '[aria-label="Edit region\'s meta"]',
  _editableFieldInput: ".sf-region-editor__input",
  _editableFieldTitle: ".sf-region-editor__text",
  _metaField: ".sf-detailed-region__meta-text",
  _resultBlockSelector: ".sf-detailed-region__result",
  _resultTitleSelector: ".ant-typography,[class*='typography-']",
  _resultValueSelector: ".sf-region-meta__value",
  _sectionHeadSelector: ".sf-details__section-head",
  locateDetailPanel() {
