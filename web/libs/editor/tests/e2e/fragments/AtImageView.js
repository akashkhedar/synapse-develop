...
module.exports = {
  ...
  _toolBarSelector: ".sf-toolbar",
  _zoomPresetsSelector: '[title^="Zoom presets"]',

  _rootSelector: '[class^="sf-object wrapperComponent--"]',
  _paginationSelector: '[class^="pagination--"]',
  _paginationPrevBtnSelector: ".sf-pagination__btn_arrow-left:not(.sf-pagination__btn_arrow-left-double)",
  _paginationNextBtnSelector: ".sf-pagination__btn_arrow-right:not(.sf-pagination__btn_arrow-right-double)",
  ...
  hasSelectedTool(toolCode) {
    I.seeElement(`.sf-tool_active${this.locateToolByCode(toolCode).toString()}`);
  },
