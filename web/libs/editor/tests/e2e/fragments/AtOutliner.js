...
module.exports = {
  _rootSelector: ".sf-outliner",
  _regionListSelector: ".sf-outliner-tree",
  _regionListItemSelector: ".sf-tree__node:not(.sf-tree__node_type_footer)",
  _regionListItemSelectedSelector: ".sf-tree-node-selected",
  _regionListItemIndex: ".sf-outliner-item__index",
  _regionVesibilityActionButton: ".sf-outliner-item__control_type_visibility button",
  _incompleteStateIcon: ".sf-outliner-item__incomplete",
  locateOutliner() {
