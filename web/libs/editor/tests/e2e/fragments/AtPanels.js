 ...
 */
class Panel {
  container = ".sf-sidepanels";
  root = ".sf-panel";
  detached = ".sf-panel_detached";
  aligmentLeft = ".sf-panel_alignment_left";
  aligmentRight = ".sf-panel_alignment_right";
  header = ".sf-panel__header";
  body = ".sf-panel__body";
  title = ".sf-panel__title";

  leftZone = ".sf-sidepanels__wrapper_align_left";
  rightZone = ".sf-sidepanels__wrapper_align_right";

  collapsingToggle = ".sf-panel__toggle";
