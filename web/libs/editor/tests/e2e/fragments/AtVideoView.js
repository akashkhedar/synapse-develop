...
module.exports = {
  _rootSelector: ".sf-video-segmentation",
  _videoRootSelector: ".sf-video__main",
  _trackSelector: ".sf-seeker__track",
  _indicatorSelector: ".sf-seeker__indicator",
  _positionSelector: ".sf-seeker__position",
