...
FFlagMatrix(["fflag_feat_front_lsdv_e_278_contextual_scrolling_short"], (flags) => {
  FFlagScenario("Check if regions are selected", async ({ I, Synapse, AtAudioView, AtOutliner }) => {
  ...
  if (!flags.fflag_feat_front_lsdv_e_278_contextual_scrolling_short) {
    FFlagScenario(
      ...
      async ({ I, Synapse, AtAudioView, AtOutliner, AtLabels }) => {
        Synapse.setFeatureFlags({
          ff_front_dev_2715_audio_3_280722_short: true,
          ...flags,
        });
    ...
    FFlagScenario("Can select a region below a hidden region", async ({ I, Synapse, AtAudioView, AtOutliner }) => {
      Synapse.setFeatureFlags({
        ff_front_dev_2715_audio_3_280722_short: true,
        ...flags,
      });
    ...
    FFlagScenario(
      ...
      async ({ I, Synapse, AtAudioView, AtOutliner }) => {
        Synapse.setFeatureFlags({
          ff_front_dev_2715_audio_3_280722_short: true,
          ...flags,
        });
    ...
    FFlagScenario("Delete region by pressing delete hotkey", async ({ I, Synapse, AtAudioView, AtOutliner }) => {
      Synapse.setFeatureFlags({
        ff_front_dev_2715_audio_3_280722_short: true,
        ...flags,
      });
    ...
    FFlagScenario("Check if there are ghost regions", async ({ I, Synapse, AtAudioView, AtOutliner }) => {
      Synapse.setFeatureFlags({
        ff_front_dev_2715_audio_3_280722_short: true,
        ...flags,
      });
