...
Scenario("Check if regions are selected", async ({ I, Synapse, AtAudioView, AtOutliner }) => {
...
Scenario("Can select a region below a hidden region", async ({ I, Synapse, AtAudioView, AtOutliner }) => {
  Synapse.setFeatureFlags({
    ff_front_dev_2715_audio_3_280722_short: true,
  });
  I.amOnPage("/");
...
Scenario("Delete region by pressing delete hotkey", async ({ I, Synapse, AtAudioView, AtOutliner }) => {
  Synapse.setFeatureFlags({
    ff_front_dev_2715_audio_3_280722_short: true,
  });
  I.amOnPage("/");
...
Scenario("Check if there are ghost regions", async ({ I, Synapse, AtAudioView, AtOutliner }) => {
  Synapse.setFeatureFlags({
    ff_front_dev_2715_audio_3_280722_short: true,
  });
  I.amOnPage("/");
