...
Data(shapesTable).Scenario("Rotate zoomed", async ({ I, Synapse, AtImageView, AtOutliner, AtPanels, current }) => {
  const params = {
...
Data(layoutVariations).Scenario(
  ...
  async ({ I, Synapse, AtImageView, AtOutliner, AtSettings, AtPanels, current }) => {
    I.amOnPage("/");
