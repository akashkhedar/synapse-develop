...
Data(maxUsageImageToolsDataTable).Scenario(
  ...
  async ({ I, Synapse, AtImageView, AtOutliner, AtPanels, Modals, current }) => {
...
Data(maxUsageDataTable).Scenario(
  ...
  async ({ I, Synapse, AtOutliner, AtAudioView, Modals, current }) => {
...
Data(maxUsageDataTable).Scenario(
  ...
  async ({ I, Synapse, AtOutliner, AtRichText, Modals, current }) => {
    const { maxUsage } = current;
...
Data(maxUsageDataTable).Scenario(
  ...
  async ({ I, Synapse, AtOutliner, AtParagraphs, current }) => {
    const { maxUsage } = current;
...
Data(maxUsageDataTable).Scenario(
  ...
  async ({ I, Synapse, AtOutliner, AtTimeSeries, Modals, current }) => {
    const { maxUsage } = current;
