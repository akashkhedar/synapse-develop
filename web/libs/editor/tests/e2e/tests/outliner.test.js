...
Scenario("Basic details", async ({ I, Synapse, AtOutliner, AtDetails }) => {
...
`,
  ...
  const isRelativeCoords = await Synapse.hasFF("fflag_fix_front_dev_3793_relative_coords_short");
  ...
  const resultWithMeta = await Synapse.serialize();
