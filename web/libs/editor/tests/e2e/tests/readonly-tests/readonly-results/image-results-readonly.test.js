...
Data(imageExamples).Scenario("Image Readonly Results", async ({ I, current, Synapse, AtOutliner, AtImageView }) => {
  I.amOnPage("/");
  ...
  await Synapse.resultsNotChanged(result, 1);
  ...
  await Synapse.resultsChanged(result, 1);
