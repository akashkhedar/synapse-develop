...
Scenario("Basic Bitmask drawing", async ({ I, Synapse, AtImageView, AtLabels }) => {
  const params = {
    config,
    data: { image: IMAGE },
...
Scenario("Bitmask eraser functionality", async ({ I, Synapse, AtImageView, AtLabels }) => {
  const params = {
    config,
    data: { image: IMAGE },
    annotations: [{ id: 1, result: [] }],
...
Scenario("Bitmask size controls", async ({ I, Synapse, AtImageView, AtLabels }) => {
  const params = {
    config,
    data: { image: IMAGE },
    annotations: [{ id: 1, result: [] }],
...
Scenario("Bitmask hover and selection", async ({ I, Synapse, AtImageView, AtLabels, AtOutliner }) => {
  const params = {
    config,
    data: { image: IMAGE },
    annotations: [{ id: 1, result: [] }],
...
Scenario("Verify Bitmask drawing content", async ({ I, Synapse, AtImageView, AtLabels }) => {
  const params = {
    config,
    data: { image: IMAGE },
    annotations: [{ id: 1, result: [] }],
...
Scenario("Verify Bitmask pixel content", async ({ I, Synapse, AtImageView, AtLabels }) => {
  const params = {
    config,
    data: { image: IMAGE },
    annotations: [{ id: 1, result: [] }],
...
Scenario("Verify Bitmask canvas fit", async ({ I, Synapse, AtImageView, AtLabels }) => {
  const params = {
    config,
    data: { image: IMAGE },
    annotations: [{ id: 1, result: [] }],
