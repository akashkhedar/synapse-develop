...
Scenario("Drawing with ctrl pressed", async ({ I, Synapse, AtOutliner, AtImageView, AtPanels }) => {
  const params = {
...
Scenario("How it works without ctrl", async ({ I, Synapse, AtOutliner, AtImageView }) => {
  const params = {
