...
Scenario("Broken limits", async ({ I, Synapse, AtOutliner }) => {
  I.amOnPage("/");
  Synapse.init({
    annotations: [
      {
...
Scenario("The selection in degenerate cases", async ({ I, Synapse, AtOutliner, AtRichText }) => {
  I.amOnPage("/");
  Synapse.init({
...
Scenario("Exactly 1 word", async ({ I, Synapse, AtOutliner, AtRichText }) => {
  I.amOnPage("/");
  Synapse.init({
    annotations: [
      {
...
Scenario("Trim spaces around the word", async ({ I, Synapse, AtOutliner, AtRichText }) => {
  I.amOnPage("/");
  Synapse.init({
    annotations: [
      {
...
Scenario("Trim spaces with BRs", async ({ I, Synapse, AtOutliner, AtRichText }) => {
  I.amOnPage("/");
  Synapse.init({
    annotations: [
      {
...
Scenario("Overlap checks", async ({ I, Synapse, AtOutliner, AtRichText }) => {
  I.amOnPage("/");
  Synapse.init({
    annotations: [
      {
...
Scenario("Non-standard characters in words", async ({ I, Synapse, AtOutliner, AtRichText }) => {
  I.amOnPage("/");
  Synapse.init({
    annotations: [
      {
...
Scenario("Should not select words from next line", async ({ I, Synapse, AtOutliner, AtRichText }) => {
  I.amOnPage("/");
  Synapse.init({
    annotations: [
      {
...
Scenario("Trying to select alt attr", async ({ I, Synapse, AtOutliner, AtRichText }) => {
  I.amOnPage("/");
  Synapse.init({
    annotations: [
      {
...
Scenario("Neighboring nested regions misplacement", async ({ I, Synapse, AtOutliner, AtRichText }) => {
  I.amOnPage("/");
  Synapse.init({
    annotations: [
      {
...

{
  ...
  Data(startBeforeEndParams).Scenario("Start before end problem", async ({ I, Synapse, AtOutliner, current }) => {
