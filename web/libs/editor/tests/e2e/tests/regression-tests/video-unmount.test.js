...
Scenario("Reiniting Synapse should not left unexpected null and video tags in DOM", async ({ I, Synapse }) => {
  I.amOnPage("/");
  for (let i = 0; i < 60; i++) {
    Synapse.init({
      config: `
<View>
  ...
  <VideoRectangle name="box" toName="video" />
    ...
    // and fails the test with "Reiniting Synapse should not left unexpected null and video tags in DOM:"
