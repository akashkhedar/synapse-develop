...
Scenario(
  ...
  async ({ I, Synapse, AtOutliner, AtLabels, AtRichText }) => {
    I.amOnPage("/");
    ...
    I.seeElement(locate(".sf-region-meta__content").withText("of HTML"));
    AtOutliner.clickRegion(2);
    I.seeElement(locate(".sf-region-meta__content").withText("f H"));
    AtOutliner.clickRegion(3);
    I.seeElement(locate(".sf-region-meta__content").withText("This is an example\nof HTML"));
    AtOutliner.clickRegion(4);
    I.seeElement(locate(".sf-region-meta__content").withText("example"));
