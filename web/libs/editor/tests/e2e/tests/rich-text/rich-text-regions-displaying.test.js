...
Scenario("Display correct colors", async ({ I, Synapse, AtLabels, AtRichText }) => {
  I.amOnPage("/");
  Synapse.init({
    config: `<View>
...
Scenario("Displaying selected and highlighted regions", async ({ I, Synapse, AtOutliner, AtDetails }) => {
  I.amOnPage("/");
  Synapse.init({
    config: `<View>
...
Scenario("Displaying label in the region", async ({ I, Synapse, AtOutliner, AtSettings }) => {
