...
Scenario("Play/pause of multiple synced audio stay in sync", async ({ I, Synapse, AtAudioView }) => {
 ...
 */
Scenario.skip("Looping of multiple synced audio stay in sync", async ({ I, Synapse, AtAudioView }) => {
  Synapse.setFeatureFlags({
    ff_front_dev_2715_audio_3_280722_short: true,
  });
...
Scenario("Seeking of multiple synced audio stay in sync", async ({ I, Synapse, AtAudioView }) => {
  Synapse.setFeatureFlags({
    ff_front_dev_2715_audio_3_280722_short: true,
  });
