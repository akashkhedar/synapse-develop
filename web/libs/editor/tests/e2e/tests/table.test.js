...
Scenario("Check if the table is sorted", async ({ I, Synapse, AtTableView }) => {
...
Scenario("Render JSON array of objects with derived columns", async ({ I, Synapse }) => {
  const listConfig = `
<View>
...
Scenario("Render JSON array of primitives as key/value table", async ({ I, Synapse }) => {
  const listKVConfig = `
<View>
