...
`,
    ...
    shouldSelectRegion: true,
    fieldSelector: ".sf-textarea-tag__form input",
    text: 'The "H1" Header',
    textAlt: 'the "h1" HEADER',
    textOther: "Wrong text",
  },
...
Data(scenarioDataTable).Scenario(
  ...
  async ({ I, Synapse, AtOutliner, Modals, current }) => {
...
Scenario("Independent skip duplicate values", async ({ I, Synapse, AtOutliner, Modals }) => {
  I.amOnPage("/");
  Synapse.init({
    data: { letter: "Aa" },
    config: `<View>
  ...
  I.fillField(AtOutliner.locateSelectedItem(".sf-textarea-tag__form input"), "A");
  I.pressKey("Enter");
 ...
 */
Scenario.skip("Skip duplicate values on editing", async ({ I, Synapse, AtOutliner, Modals }) => {
  I.amOnPage("/");
  Synapse.init({
    data: { letter: "Aa" },
    config: `<View>
  ...
  I.see("1", locate(".sf-text-area").at(1).find(locate(".//*[./@data-testid = 'textarea-region'][position()=2]")));
  I.dontSee("A", locate(".sf-text-area").at(1).find(locate(".//*[./@data-testid = 'textarea-region'][position()=2]")));

  I.say("Delete second region and check results after that");
  I.click(
    locate('[aria-label="Delete Region"]'),
    locate(".sf-text-area").at(1).find(locate(".//*[./@data-testid = 'textarea-region'][position()=2]")),
  );

  I.see("A", locate(".sf-text-area").at(1).find(locate(".//*[./@data-testid = 'textarea-region'][position()=1]")));
  I.see(
    "letter",
    locate(".sf-text-area").at(1).find(locate(".//*[./@data-testid = 'textarea-region'][position()=2]")),
  );
  I.see("last", locate(".sf-text-area").at(1).find(locate(".//*[./@data-testid = 'textarea-region'][position()=3]")));

  {
    const result = await Synapse.serialize();
  ...
  I.see("other", locate(".sf-text-area").at(1).find(locate(".//*[./@data-testid = 'textarea-region'][position()=2]")));
  Modals.dontSeeWarning(SKIP_DUPLICATES_ERROR);
  ...
  I.say("Check that these changes were not committed");
  I.see("1", locate(".sf-text-area").at(2).find(locate(".//*[./@data-testid = 'textarea-region'][position()=2]")));
  I.dontSee("a", locate(".sf-text-area").at(2).find(locate(".//*[./@data-testid = 'textarea-region'][position()=2]")));

  I.say("Delete second region and check results after that");
  I.click(
    locate('[aria-label="Delete Region"]'),
    locate(".sf-text-area").at(2).find(locate(".//*[./@data-testid = 'textarea-region'][position()=2]")),
  );

  I.see("a", locate(".sf-text-area").at(2).find(locate(".//*[./@data-testid = 'textarea-region'][position()=1]")));
  I.see(
    "letter",
    locate(".sf-text-area").at(2).find(locate(".//*[./@data-testid = 'textarea-region'][position()=2]")),
  );
  I.see("last", locate(".sf-text-area").at(2).find(locate(".//*[./@data-testid = 'textarea-region'][position()=3]")));
  ...
  I.see("other", locate(".sf-text-area").at(2).find(locate(".//*[./@data-testid = 'textarea-region'][position()=2]")));
  Modals.dontSeeWarning(SKIP_DUPLICATES_ERROR);
  ...
  I.fillField(AtOutliner.locateSelectedItem(".sf-textarea-tag__form input"), "One");
  I.pressKey("Enter");
  I.fillField(AtOutliner.locateSelectedItem(".sf-textarea-tag__form input"), "Two");
  I.pressKey("Enter");
  I.fillField(AtOutliner.locateSelectedItem(".sf-textarea-tag__form input"), "Three");
  I.pressKey("Enter");
  I.fillField(AtOutliner.locateSelectedItem(".sf-textarea-tag__form input"), "Four");
  I.pressKey("Enter");

  I.say("Try to create duplicate value by editing");

  I.click(AtOutliner.locateSelectedItem(locate(".sf-textarea-tag__item:nth-child(2) input")));
  I.pressKey(["CommandOrControl", "a"]);
  I.pressKey("Backspace");
  I.pressKey("O");
  I.pressKey("n");
  ...
  I.say("Check that these changes were not committed");
  I.seeInField(AtOutliner.locateSelectedItem(locate(".sf-textarea-tag__item:nth-child(2) input")), "Two");
  I.dontSeeInField(AtOutliner.locateSelectedItem(locate(".sf-textarea-tag__item:nth-child(2) input")), "One");

  I.say("Delete second region and check results after that");
  I.click(
    locate('[aria-label="Delete Region"]'),
    AtOutliner.locateSelectedItem(locate(".sf-textarea-tag__item:nth-child(2)")),
  );

  I.seeInField(AtOutliner.locateSelectedItem(locate(".sf-textarea-tag__item:nth-child(1) input")), "One");
  I.seeInField(AtOutliner.locateSelectedItem(locate(".sf-textarea-tag__item:nth-child(2) input")), "Three");
  I.seeInField(AtOutliner.locateSelectedItem(locate(".sf-textarea-tag__item:nth-child(3) input")), "Four");
  ...
  I.seeInField(AtOutliner.locateSelectedItem(locate(".sf-textarea-tag__item:nth-child(2) input")), "other");
  Modals.dontSeeWarning(SKIP_DUPLICATES_ERROR);
