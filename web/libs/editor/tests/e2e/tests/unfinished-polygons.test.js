...
Scenario("Drafts for unfinished polygons", async ({ I, Synapse, AtLabels, AtImageView }) => {
  I.amOnPage("/");
  Synapse.init({
    config: CONFIG,
    data: {
...
Scenario("Saving polygon drawing steps to history", async ({ I, Synapse, AtLabels, AtImageView }) => {
  I.amOnPage("/");
  Synapse.init({
    config: CONFIG,
    data: {
...
Scenario("Init an annotation with old format of closed polygon result", async ({ I, Synapse, AtImageView }) => {
  I.amOnPage("/");
  Synapse.init({
    config: CONFIG,
    data: {
...
Scenario("Init an annotation with result of new format of polygon results", async ({ I, Synapse, AtImageView }) => {
  I.amOnPage("/");
  Synapse.init({
    config: CONFIG,
    data: {
...
Scenario("Removing a polygon by going back through history", async ({ I, Synapse, AtLabels, AtImageView }) => {
  I.amOnPage("/");
  Synapse.init({
    config: CONFIG,
    data: {
...
Scenario("Continue annotating after closing region from draft", async ({ I, Synapse, AtLabels, AtImageView }) => {
  I.amOnPage("/");
  Synapse.init({
    config: CONFIG,
    data: {
...
Scenario("Change label on unfinished polygons", async ({ I, Synapse, AtLabels, AtImageView }) => {
  I.amOnPage("/");
  Synapse.init({
    config: CONFIG,
    data: {
...
Data(selectedLabelsVariants).Scenario(
  ...
  async ({ I, Synapse, AtLabels, AtImageView, current }) => {
...
Data(selectedPolygonAfterCreatingVariants).Scenario(
  ...
  async ({ I, Synapse, AtImageView, AtOutliner, AtSettings, current }) => {
