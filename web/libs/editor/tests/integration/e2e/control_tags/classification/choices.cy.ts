import { Synapse, ImageView, Choices, ToolBar, Modals, Sidebar } from "@synapse/frontend-test/helpers/SF";
import {
...
describe("Classification - single image - Choices", () => {
  it("should create result without item_index", () => {
    Synapse.params().config(simpleImageChoicesConfig).data(simpleImageData).withResult([]).init();
  ...
  it("should load perTag result correctly", () => {
    Synapse.params().config(simpleImageChoicesConfig).data(simpleImageData).withResult(perTagChoicesResult).init();
...
describe("Classification - MIG perTag - Choices", () => {
  it("should not have item_index in result", () => {
    Synapse.params().config(perTagMIGChoicesConfig).data(simpleMIGData).withResult([]).init();
  ...
  it("should load perTag result correctly", () => {
    Synapse.params().config(perTagMIGChoicesConfig).data(simpleMIGData).withResult(perTagChoicesResult).init();
  ...
  it("should require result", () => {
    Synapse.params().config(requiredPerTagMIGChoicesConfig).data(simpleMIGData).withResult([]).init();
...
describe("Control Tags - MIG perItem - Choices", () => {
  it("should create result with item_index", () => {
    Synapse.params().config(perItemMIGChoicesConfig).data(simpleMIGData).withResult([]).init();
  ...
  it("should load perItem result correctly", () => {
    Synapse.params().config(perItemMIGChoicesConfig).data(simpleMIGData).withResult(perItemChoicesResult).init();
