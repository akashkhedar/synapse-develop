import { Synapse, ImageView, DateTime, Modals, Sidebar, ToolBar } from "@synapse/frontend-test/helpers/SF";
import {
...
describe("Classification - single image - DateTime", () => {
  it("should create result without item_index", () => {
    Synapse.params().config(simpleImageDateTimeConfig).data(simpleImageData).withResult([]).init();
...
describe("Classification - MIG perTag - DateTime", () => {
  it("should not have item_index in result", () => {
    Synapse.params().config(perTagMIGDateTimeConfig).data(simpleMIGData).withResult([]).init();
  ...
  it("should load perTag result correctly", () => {
    Synapse.params().config(perTagMIGDateTimeConfig).data(simpleMIGData).withResult(perTagDateTimeResult).init();
  ...
  it("should require result", () => {
    Synapse.params().config(requiredPerTagMIGDateTimeConfig).data(simpleMIGData).withResult([]).init();
...
describe("Control Tags - MIG perItem - DateTime", () => {
  it("should create result with item_index", () => {
    Synapse.params().config(perItemMIGDateTimeConfig).data(simpleMIGData).withResult([]).init();
  ...
  it("should load perItem result correctly", () => {
    Synapse.params().config(perItemMIGDateTimeConfig).data(simpleMIGData).withResult(perItemDateTimeResult).init();
