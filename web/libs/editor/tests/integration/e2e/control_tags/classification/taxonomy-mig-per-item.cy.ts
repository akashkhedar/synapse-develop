...
describe("Control Tags - MIG perItem - Taxonomy", () => {
  it("should create result with item_index", () => {
    Synapse.params().config(perItemMIGTaxonomyConfig).data(simpleMIGData).withResult([]).init();
  ...
  it("should load perItem result correctly", () => {
    Synapse.params().config(perItemMIGTaxonomyConfig).data(simpleMIGData).withResult(perItemTaxonomyResult).init();
