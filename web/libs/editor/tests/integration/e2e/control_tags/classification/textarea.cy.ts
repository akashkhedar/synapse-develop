import { Synapse, ImageView, Textarea, ToolBar, Modals, Sidebar } from "@synapse/frontend-test/helpers/SF";
import {
...
describe("Classification - single image - Textarea", () => {
  it("should create result without item_index", () => {
    Synapse.params().config(simpleImageTextareaConfig).data(simpleImageData).withResult([]).init();
...
describe("Classification - MIG perTag - Textarea", () => {
  it("should not have item_index in result", () => {
    Synapse.params().config(perTagMIGTextareaConfig).data(simpleMIGData).withResult([]).init();
  ...
  it("should load perTag result correctly", () => {
    Synapse.params().config(perTagMIGTextareaConfig).data(simpleMIGData).withResult(perTagTextareaResult).init();
  ...
  it("should require result", () => {
    Synapse.params().config(requiredPerTagMIGTextareaConfig).data(simpleMIGData).withResult([]).init();
...
describe("Control Tags - MIG perItem - Textarea", () => {
  it("should create result with item_index", () => {
    Synapse.params().config(perItemMIGTextareaConfig).data(simpleMIGData).withResult([]).init();
  ...
  it("should load perItem result correctly", () => {
    Synapse.params().config(perItemMIGTextareaConfig).data(simpleMIGData).withResult(perItemTextareaResult).init();
