import { Synapse, Sidebar, Textarea, ToolBar } from "@synapse/frontend-test/helpers/SF";
import {
  simpleData,
...
describe("Control Tags - TextArea - Lead Time", () => {
  ...
  it("should calculate lead_time for global TextArea", () => {
    Synapse.params().config(textareaConfigSimple).data(simpleData).withResult([]).init();
    ...
    Synapse.serialize().then((result) => {
      ...
      Synapse.serialize().then((result2) => {
  ...
  it("should calculate lead_time for per-region TextArea", () => {
    Synapse.params().config(textareaConfigPerRegion).data(simpleData).withResult(textareaResultsPerRegion).init();
...
describe("Control Tags - TextArea - Pre-filled Value", () => {
  it("should display pre-filled value in the input field", () => {
    Synapse.params().config(textareaConfigWithValue).data(simpleData).withResult([]).init();
  ...
  it("should show pre-filled value even when there are existing text regions", () => {
    ...
    Synapse.params().config(textareaConfigWithValue).data(simpleData).withResult(existingResult).init();
  ...
  it("should work with multi-row textarea", () => {
    Synapse.params().config(textareaConfigWithValueAndRows).data(simpleData).withResult([]).init();
...
describe("Control Tags - TextArea - Auto-submit on Annotation Submit", () => {
  ...
  it("should not auto-submit when maxSubmissions is reached and input is hidden", () => {
    Synapse.params().config(textareaConfigWithMaxSubmissions).data(simpleData).withResult([]).init();
  ...
  it("should not auto-submit pre-filled value when maxSubmissions is reached", () => {
    Synapse.params().config(textareaConfigWithValueAndMaxSubmissions).data(simpleData).withResult([]).init();
  ...
  it("should not auto-submit when annotation is loaded with maxSubmissions already reached", () => {
    ...
    Synapse.params().config(textareaConfigWithMaxSubmissions).data(simpleData).withResult(existingResult).init();
