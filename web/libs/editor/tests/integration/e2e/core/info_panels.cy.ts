...
describe("Synapse UI info panels", () => {
  it("Open every panel and interact with regions", () => {
    ...
    cy.get("[class$=sf-outliner-item__title").contains("Word1").should("be.visible");
    ...
    cy.get("[class$=sf-outliner-item__title").contains("Word2").should("be.visible");
