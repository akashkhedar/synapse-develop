...
describe("Image segmentation - Tools - Selection tool", () => {
  describe("Сlick interactions", () => {
    it("Should select rectangle region by clicking on center", () => {
      Synapse.params().config(simpleRectangleConfig).data(simpleImageData).withResult(simpleRectangleResult).init();
    ...
    it("Should select ellipse region by clicking on center", () => {
      Synapse.params().config(simpleEllipseConfig).data(simpleImageData).withResult(simpleEllipseResult).init();
    ...
    it("Should select polygon region by clicking on it", () => {
      Synapse.params().config(simplePolygonConfig).data(simpleImageData).withResult(simplePolygonResult).init();
    ...
    it("Should select keypoint region by clicking on it", () => {
      Synapse.params().config(simplePointConfig).data(simpleImageData).withResult(simplePointResult).init();
    ...
    it("Should select a couple of regions by clicking with Ctrl pressed", () => {
      Synapse.params().config(simpleRectangleConfig).data(simpleImageData).withResult(fourRectanglesResult).init();
  ...
  describe("Selecting area", () => {
    ...
    it("Should disappear after mouseup", () => {
      Synapse.params().config(simpleRectangleConfig).data(simpleImageData).withResult([]).init();
