...
import { Paragraphs } from "@synapse/frontend-test/helpers/SF/Paragraphs";
import {
...
describe("Multiple Label Blocks - All Object Tags", () => {
  ...
  describe("Image Object Tag", () => {
    it("should create separate results for each label block - RectangleLabels", () => {
      cy.log("Initialize SF with Image and multiple RectangleLabels blocks");
      Synapse.params()
    ...
    it("should create separate results for each label block - PolygonLabels", () => {
      cy.log("Initialize SF with Image and multiple PolygonLabels blocks");
      Synapse.params()
  ...
  describe("Text Object Tag", () => {
    it("should create separate results for each label block", () => {
      cy.log("Initialize SF with Text and multiple Labels blocks");
      Synapse.params()
  ...
  describe("HyperText Object Tag", () => {
    it("should create separate results for each label block", () => {
      cy.log("Initialize SF with HyperText and multiple HyperTextLabels blocks");
      Synapse.params()
  ...
  describe("Paragraphs Object Tag", () => {
    it("should create separate results for each label block", () => {
      cy.log("Initialize SF with Paragraphs and multiple ParagraphLabels blocks");
      Synapse.params()
  ...
  describe("Audio Object Tag", () => {
    it("should create separate results for each label block", () => {
      cy.log("Initialize SF with Audio and multiple Labels blocks");
      Synapse.params()
  ...
  describe("TimeSeries Object Tag", () => {
    it("should create separate results for each label block", () => {
      cy.log("Initialize SF with TimeSeries and multiple TimeSeriesLabels blocks");
      Synapse.params()
  ...
  describe("Video Object Tag", () => {
    ...
    it.skip("should create separate results for each label block", () => {
      cy.log("Initialize SF with Video and multiple Labels blocks");
      Synapse.params()
    ...
    it("should create separate results for each timeline label block", () => {
      cy.log("Initialize SF with Video and multiple TimelineLabels blocks");
      Synapse.params()
