import { Synapse, TimeSeries } from "@synapse/frontend-test/helpers/SF";
import {
  multiChannelConfig,
  singleChannelConfig,
...
describe("TimeSeries charts displaying - MultiChannel", () => {
  it("should not displace charts while navigating", () => {
    ...
    Synapse.params().config(multiChannelConfig).data(heavyDatasetForDisplacement).withResult([]).init();
...
describe("TimeSeries charts displaying - Single Channel", () => {
  it("should not displace charts while navigating", () => {
    ...
    Synapse.params().config(singleChannelConfig).data(heavyDatasetForDisplacement).withResult([]).init();
