import { Collapse, Synapse } from "@synapse/frontend-test/helpers/SF";
import {
  simpleData,
  basicCollapseConfig,
...
describe("Visual Tags - Collapse", () => {
  describe("Basic functionality", () => {
    it("should render Collapse with default settings", () => {
      Synapse.params().config(basicCollapseConfig).data(simpleData).withResult([]).init();
  ...
  describe("Accordion mode", () => {
    ...
    it("should allow multiple panels open when accordion=false", () => {
      Synapse.params().config(nonAccordionCollapseConfig).data(simpleData).withResult([]).init();
  ...
  describe("Bordered style", () => {
    it("should show borders when bordered=true", () => {
      Synapse.params().config(borderedCollapseConfig).data(simpleData).withResult([]).init();
  ...
  describe("Open parameter behavior", () => {
    it("should open all panels when global open=true", () => {
      Synapse.params().config(globalOpenCollapseConfig).data(simpleData).withResult([]).init();
    ...
    it("should respect panel-level open overrides", () => {
      Synapse.params().config(mixedOpenCollapseConfig).data(simpleData).withResult([]).init();
    ...
    it("should allow panels to override global open=true", () => {
      Synapse.params().config(globalOpenWithOverridesConfig).data(simpleData).withResult([]).init();
  ...
  describe("All parameters combined", () => {
    it("should work with all parameters set together", () => {
      Synapse.params().config(allParamsCollapseConfig).data(simpleData).withResult([]).init();
  ...
  describe("Edge cases", () => {
    it("should handle empty panels", () => {
      ...
      Synapse.params().config(emptyPanelConfig).data(simpleData).withResult([]).init();
    ...
    it("should handle panels with only whitespace content", () => {
      ...
      Synapse.params().config(whitespaceConfig).data(simpleData).withResult([]).init();
