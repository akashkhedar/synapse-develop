...
import { withMedia } from "@synapse/frontend-test/helpers/utils/media/MediaMixin";
import { Synapse } from "@synapse/frontend-test/helpers/SF/Synapse";
import type { ViewWithMedia } from "@synapse/frontend-test/helpers/utils/media/types";
...
class AudioViewHelper extends withMedia(
  class implements ViewWithMedia {
    ...
    get timelineControls() {
      return this.root.find(".sf-timeline-controls");
    }

    get currentTimebox() {
      return this.timelineControls.find('[data-testid="timebox-current-time"] > .sf-time-box__input-time');
    }

    get endTimebox() {
      return this.timelineControls.find('[data-testid="timebox-end-time"] > .sf-time-box__input-time');
    }

    get configButton() {
      return this.timelineControls.find(".sf-audio-config > [aria-label='Audio settings']");
    }
    get volumeButton() {
      return this.timelineControls.find(".sf-audio-control > .sf-button");
    }
    ...
    get volumeSlider() {
      return this.root.find(".sf-audio-slider__range");
    }

    get volumeInput() {
      return this.root.find(".sf-audio-slider__input");
    }

    get muteButton() {
      return this.root.find(".sf-audio-control__mute-button");
    }

    get playbackSpeedSlider() {
      return cy.get(
        ".sf-audio-config__modal > .sf-audio-config__scroll-content > .sf-audio-slider:nth-child(2) .sf-audio-slider__range",
      );
    }

    get playbackSpeedInput() {
      return cy.get(
        ".sf-audio-config__modal > .sf-audio-config__scroll-content > .sf-audio-slider:nth-child(2) .sf-audio-slider__input",
      );
    }

    get amplitudeSlider() {
      return cy.get(
        ".sf-audio-config__modal > .sf-audio-config__scroll-content > .sf-audio-slider:nth-child(3) .sf-audio-slider__range",
      );
    }

    get amplitudeInput() {
      return cy.get(
        ".sf-audio-config__modal > .sf-audio-config__scroll-content > .sf-audio-slider:nth-child(3) .sf-audio-slider__input",
      );
    }

    get hideTimelineButton() {
      return this.root.get(".sf-audio-config__buttons > .sf-audio-config__menu-button:nth-child(1)");
    }

    get hideWaveformButton() {
      return this.root.get(".sf-audio-config__buttons > .sf-audio-config__menu-button:nth-child(2)");
    }
