...
export const ImageView = {
  ...
  get root() {
    return this.image.closest(".sf-object");
  },
  get drawingFrame() {
  ...
  get toolBar() {
    cy.log("Get tool bar");
    return this.root.find(".sf-toolbar");
  },
  get pagination() {
    return this.root.get('[class^="pagination--"]');
  },
  get paginationPrevBtn() {
    return this.pagination.get(".sf-pagination__btn_arrow-left:not(.sf-pagination__btn_arrow-left-double)");
  },
  get paginationNextBtn() {
    return this.pagination.get(".sf-pagination__btn_arrow-right:not(.sf-pagination__btn_arrow-right-double)");
  },
  waitForImage() {
  ...
  selectRectangleToolByButton() {
    this.toolBar
      ...
      .should("be.visible")
      .click()
      .should("have.class", "sf-tool_active");
  },
  ...
  selectPolygonToolByButton() {
    this.toolBar.find('[aria-label="polygon-tool"]').should("be.visible").click().should("have.class", "sf-tool");
  },
  ...
  selectBrushToolByButton() {
    this.toolBar.find('[aria-label="brush-tool"]').should("be.visible").click().should("have.class", "sf-tool_active");
  },

  selectMoveToolByButton() {
    this.toolBar.find('[aria-label="move-tool"]').should("be.visible").click().should("have.class", "sf-tool_active");
  },
