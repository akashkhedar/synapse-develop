...
import { cnb as cn } from "@synapse/core/lib/utils/bem";
import { alignElements, type Align } from "@synapse/core/lib/utils/dom";
import { aroundTransition } from "@synapse/core/lib/utils/transition";
...
export interface DropdownProps {
  ...
  /** Additional callback when visibility changes (from Synapse) */
