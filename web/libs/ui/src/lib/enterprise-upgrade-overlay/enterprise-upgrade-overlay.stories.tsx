...
export const ProjectDashboards: Story = {
  args: {
    ...
    learnMoreUrl: "https://docs.Synapse.com/guide/dashboards.html",
  },
};
...
export const SSOAndSecurity: Story = {
  args: {
    ...
    learnMoreUrl: "https://docs.Synapse.com/guide/security.html",
...
export const CustomWorkflows: Story = {
  args: {
    ...
    learnMoreUrl: "https://docs.Synapse.com/guide/workflows.html",
  },
};
...
export const CustomButtonLabels: Story = {
  args: {
    ...
    learnMoreUrl: "https://Synapse.com/pricing",
  },
};
