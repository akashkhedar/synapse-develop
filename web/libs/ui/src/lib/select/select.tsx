...
import {
  ...
  CommandItem,
  CommandList,
} from "@synapse/shad/components/ui/command";
import { Popover, PopoverContent, PopoverTrigger } from "@synapse/shad/components/ui/popover";
import type { SelectOption, OptionProps, SelectProps } from "./types.ts";
import { Checkbox, Label } from "@synapse/ui";
import { isDefined } from "@synapse/core/lib/utils/helpers";
import { IconChevron, IconChevronDown } from "@synapse/icons";
